This is a [Node.JS](https://nodejs.org/en) project that maintains a list of Narrow-One versions. It utilizes cron jobs using [Github Actions](https://github.com/features/actions) to automate certain tasks.
